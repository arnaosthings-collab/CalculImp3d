...
FALLBACK_FR = {
    ...
    'calc.label_fournitures': "Fournitures de l'objet (vis, colle...)",
    ...
    'calc.placeholder_fournitures': 'ex : 2.50',
    'calc.row_charges': 'Charges sociales',
    'calc.row_divers': '▢  Frais divers',
    'calc.row_fournitures': '▢  Fournitures objet',
...
FALLBACK_EN = {
    ...
    'calc.label_fournitures': 'Object supplies (screws, glue...)',
    ...
    'calc.placeholder_fournitures': 'e.g. 2.50',
    'calc.row_charges': 'Social charges',
    'calc.row_divers': '▢  Misc costs',
    'calc.row_fournitures': '▢  Object supplies',
